...
-- Insight: "Manager-level roles in sales earn the 
...
-- Insight: "Sales employees stay the longest 
-- (7.3 years avg), narrowly ahead of HR (7.2) and R&D (6.9)."
...
-- 30% less than those who stayed ($4,787 vs $6,833)."
